...
class EspeakAPI:
    ...
    def __init__(self, library: Union[str, Path]):
        ...
        shutil.copy(str(library_path), str(espeak_copy), follow_symlinks=False)
        ...
        try:
            ...
            if 'PHONEMIZER_ESPEAK_LIBRARY' in os.environ:
                data_path = os.path.join(os.path.dirname(os.environ['PHONEMIZER_ESPEAK_LIBRARY']))
